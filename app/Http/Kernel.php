...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'auth.admin' => \Modules\Crm\Http\Middleware\AdminAuthenticate::class,
        'lms.admin' => \Modules\Lms\Http\Middleware\AdminLmsAuthenticate::class,
        'user.admin' => \Modules\Lms\Http\Middleware\UserLmsAuthenticate::class,
