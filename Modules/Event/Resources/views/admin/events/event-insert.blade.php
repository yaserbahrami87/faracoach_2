@component('masterView::admin.master.index')
    <div class="col-12 col-md-6 mx-auto card">
            ...
            <div class="card-body">
                <form method="post" action="{{route('admin.event.insert')}}"  >
                    {{csrf_field()}}
                            ...
                            @foreach($organizers as $organizer)
                                <div class="col-md-3">
                                    <div class="custom-control custom-checkbox image-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="organizer{{$organizer->id}}" name="eventorganizer_id[]" value="{{$organizer->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="fi" name="fi" value="{{old('fi')}}"  />
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="dateInput form-control" id="start_date" name="start_date"  autocomplete="off"  value="{{old('start_date')}}"/>
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group">
                                ...
                                <input type="text" class="time_fa form-control time" id="start_time" name="start_time"  autocomplete="off" value="{{old('start_time')}}" />
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="dateInput form-control" id="end_date" name="end_date"  autocomplete="off" value="{{old('end_date')}}" />
                                <small class="text-muted">به عنوان مثال: 1403/01/01</small>
                                @error('end_date')
                                    <p class="text text-danger" role="alert">
                                        {{ $message }}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="time_fa form-control time" id="end_time" name="end_time"  autocomplete="off" value="{{old('end_time')}}" />
                                <small class="text-muted">به عنوان مثال: 12:12</small>
                                @error('end_time')
                                    <p class="text text-danger" role="alert">
                                        {{ $message }}
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="dateInput form-control" id="expire_date" name="expire_date"  autocomplete="off" value="{{old('expire_date')}}" />
                                <small class="text-muted">به عنوان مثال: 1403/01/01</small>
                                @error('expire_date')
                                <p class="text text-danger" role="alert">
                                    {{ $message }}
