                                ...
                                <div id="coachingTypeFilter" class="accordion-collapse collapse show bg-f8" aria-labelledby="coachingTypeFilterHeading">
                                    <div class="accordion-body">
                                        ...
                                        <div class="form-check mb-3 border-bottom pb-3">
                                            <input class="form-check-input ms-2" type="checkbox" value="{{$category->id}}" id="{{$category->title}}" wire:model.lazy="clinicCategory_select">
                                            <label class="form-check-label user-select-none p-1" for="{{$category->title}}">
                                                {{$category->title}}
                                            </label>
                                        </div>
                                        @endforeach
