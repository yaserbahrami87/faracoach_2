<div class="mx-auto col-12 col-md-6">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if($Users!=[])
                <form method="post" wire:submit.prevent="updateStudent">
                    <div class="form-group">
                        <label for="student">نتیجه جستجو:</label>
                        <select class="form-control" id="student" wire:model.change="Student.user_id">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="student" wire:model.change="Student.course_id">
                            <option value="NULL" selected>انتخاب کنید</option>
                    ...
                    <div id="insertStudent">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control dateInput" id="date" name="date_fa" autocomplete="off" wire:model.lazy="Student.date_fa"  />
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status" wire:model="Student.status">
